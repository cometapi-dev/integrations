...
echo "     sh setup.sh --add-model cometapi-openai/gpt-5-latest"
echo "     sh setup.sh --add-model cometapi-openai-responses/gpt-5-latest"
echo "     sh setup.sh --add-model cometapi-claude/claude-opus-4-5"
echo "     sh setup.sh --add-model cometapi-gemini/gemini-3.1-ultra"
echo ""
echo "  🔗 Browse all models: https://api.cometapi.com/models"
